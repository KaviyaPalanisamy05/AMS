        ...
        <aside class="left-sidebar" data-sidebarbg="skin5">
            <div class="scroll-sidebar"><br>
                ...
                <ul id="sidebarnav" class="p-t-30">
                    ...
                    <li class="sidebar-item"> <a id="view-work-task-history" class="sidebar-link waves-effect waves-dark sidebar-link" href="worker_helpline.html" aria-expanded="false"><i class="mdi mdi-blur-linear"></i><span class="hide-menu">Helpline</span></a></li>
                    </ul>
                </nav>
            </div>
        </aside>
